...
CC=g++ 
LIBS = OGRE OGRE-Overlay OGRE-Bites OIS sdl2 SDL2_mixer tinyxml
CFLAGS=-c -Wall $(shell pkg-config --cflags $(LIBS)) -I include -g
...
TextEffectorBigMessage.cpp TextEffector.cpp Tools.cpp TextGlobe.cpp Planet.cpp
