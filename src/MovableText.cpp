...
void MovableText::_setupGeometry()
{
    ...
    aa = Vector3(-mCharHeight,-mCharHeight/2.0,-1.0);
    ...
    for (i = mCaption.begin(); i != iend; ++i)
    {
        ...
        *pPCBuff++ = v2;
        ...
        bb  = Vector3(largestWidth, mCharHeight/2.0,-1.0);
    ...
    mAABB = Ogre::AxisAlignedBox(aa, bb);
...
void MovableText::_updateRenderQueue(RenderQueue* queue)
{
    if (this->isVisible())
    {
        ...
        //queue->addRenderable(this, mRenderQueueID, RENDER_QUEUE_OVERLAY);
